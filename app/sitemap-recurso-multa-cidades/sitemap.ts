...
/**
 * Sitemap de /recurso-de-multa/[uf]/[cidade] — 1 arquivo por UF (27 no total),
 * cada um listando todas as cidades daquele estado. Servido em
 * /sitemap-recurso-multa-cidades/sitemap/[id].xml e anunciado no robots.ts.
...
export default function sitemap({ id }: { id: number }): MetadataRoute.Sitemap {
  ...
  return cities.map((c) => ({
    url: `${base}/recurso-de-multa/${uf}/${c.slug}`,
