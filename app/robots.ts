...
export default function robots(): MetadataRoute.Robots {
  ...
  // Indexacao SELETIVA: so paginas de qualidade no sitemap (diretorio por cidade,
  // especialidades, jurisprudencia). As variantes /em/[cidade] de conteudo sao
  // near-duplicate (canonical->base) e foram REMOVIDAS do sitemap para nao queimar
  // crawl budget nem disparar scaled-content abuse num dominio novo.
