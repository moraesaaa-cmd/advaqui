...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${base}/como-verificamos`, changeFrequency: "yearly", priority: 0.4, lastModified: now },
    ...
    { url: `${base}/noticias`, changeFrequency: "daily", priority: 0.8, lastModified: now },
    ...
    { url: `${base}/correcao-monetaria`, changeFrequency: "monthly", priority: 0.8, lastModified: now },
    { url: `${base}/seguro-desemprego`, changeFrequency: "monthly", priority: 0.8, lastModified: now },
    { url: `${base}/revisor-peticao`, changeFrequency: "monthly", priority: 0.7, lastModified: now },
    ...
    { url: `${base}/recurso-de-multa`, changeFrequency: "monthly", priority: 0.8, lastModified: now },
    { url: `${base}/divorcio`, changeFrequency: "monthly", priority: 0.8, lastModified: now },
    { url: `${base}/triagem`, changeFrequency: "monthly", priority: 0.8, lastModified: now },
    { url: `${base}/previdencia`, changeFrequency: "monthly", priority: 0.8, lastModified: now },
    { url: `${base}/imobiliario`, changeFrequency: "monthly", priority: 0.8, lastModified: now },
